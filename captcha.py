...
for i in range (1,100):
	os.system('convert '+captcha_file+' -threshold '+str(i)+'% -paint 1 -bordercolor White -border 10x10 -blur 0 out.'+file_extension)
	if(mogrify):
	...
	if result == true_result:
		print('Success!')
		print('convert '+captcha_file+' -threshold '+str(i)+'% -paint 1 -bordercolor White -border 10x10 -blur 0 out.'+file_extension)
		if (mogrify):
